...
namespace op_impl {
    ...
    int TransposeImpl::get_elements_per_access() const {
        return 0;
    }
    ...
    TransposeImpl::get_available_implementations(std::shared_ptr<CUDAContext> cuda_context,
        ...
        return {
            std::static_pointer_cast<OpImplBase>(transpose_impl)
        };
    }
}
}
