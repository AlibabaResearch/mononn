...
class PadImpl : public OpImplBase {
 public:
  ...
  PadImpl(std::shared_ptr<CUDAContext> _cuda_context, InputSpec _input_spec,
          Tensor _output)
  ...
  //        std::string generate_if_statement_cond(std::vector<std::string>
  //        multi_index) const; std::string
  //        generate_if_statement_begin(std::vector<std::string> multi_index)
  //        const; std::string generate_if_statement_end() const; std::string
  //        generate_else() const;
