...
namespace op_impl {
    ...
    public:
        ...
        void propagate_attributes(const std::unordered_map<std::string, std::string> &attrs);
...
//        void set_concrete_index(std::vector<ConcreteIndexStamp> _concrete_index_list);
        ...
        std::string get_upstream_ilp_index_trace_node(std::string index, int ilp_id) const;

        void add_operand_reuse_mask(std::string origin_operand_name, std::string reuse_operand_name);
        ...
        // void set_ilp_traced_index(int ilp_id, std::vector<IndexTraceStamp> _traced_index_list) override;
    protected:
        ...
        // virtual void propagate_attributes_impl(const std::unordered_map<std::string, std::string> &attrs);
