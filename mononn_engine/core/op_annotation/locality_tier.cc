...
namespace op_annotation {
    ...
    std::unordered_map<std::string, OpType>* LocalityTier::get_OpT0() {
        ...
        if (registry == nullptr) {
            ...
            registry->insert(std::make_pair(OpType::bitcast.get_name(), OpType::bitcast));
            registry->insert(std::make_pair(OpType::broadcast.get_name(), OpType::broadcast));
            registry->insert(std::make_pair(OpType::clamp.get_name(), OpType::clamp));
            registry->insert(std::make_pair(OpType::concatenate.get_name(), OpType::concatenate));
            registry->insert(std::make_pair(OpType::constant.get_name(), OpType::constant));
            registry->insert(std::make_pair(OpType::convert.get_name(), OpType::convert));
            ...
            registry->insert(std::make_pair(OpType::get_tuple_element.get_name(), OpType::get_tuple_element));
            registry->insert(std::make_pair(OpType::iota.get_name(), OpType::iota));
            registry->insert(std::make_pair(OpType::maximum.get_name(), OpType::maximum));
            registry->insert(std::make_pair(OpType::minimum.get_name(), OpType::minimum));
            registry->insert(std::make_pair(OpType::multiply.get_name(), OpType::multiply));
            registry->insert(std::make_pair(OpType::pad.get_name(), OpType::pad));
            registry->insert(std::make_pair(OpType::parameter.get_name(), OpType::parameter));
            registry->insert(std::make_pair(OpType::reduce.get_name(), OpType::reduce));
            registry->insert(std::make_pair(OpType::reshape.get_name(), OpType::reshape));
            ...
            registry->insert(std::make_pair(OpType::subtract.get_name(), OpType::subtract));
    ...
    std::unordered_map<std::string, OpType>* LocalityTier::get_OpT1() {
        ...
        if (registry == nullptr) {
            registry = new std::unordered_map<std::string, OpType>;
            registry->insert(std::make_pair(OpType::custom_call.get_name(), OpType::custom_call));
            registry->insert(std::make_pair(OpType::reduce.get_name(), OpType::reduce));
        }
