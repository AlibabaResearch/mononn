...
namespace op {
    ...
    #define OP_TYPE_LIST(V) \
        ...
        V("dynamic-update", dynamic_update_slice, DynamicUpdateSlice, DynamicUpdateSlice)   \
    ...
    #define OP_TYPE_LIST_CLUSTER(V) \
        V("fusion", cluster, ClusterOp, Fusion)
    ...
    public:
        ...
        #define DECLARE_OP_TYPE(op_name, op_code, ...) \
        static const OpType op_code;
