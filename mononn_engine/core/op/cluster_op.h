...
namespace op {
    ...
    public:
        ...
        ClusterOp(std::string _name, std::vector<std::shared_ptr<Op>> _operands, std::vector<TensorSpec> _output_specs);
...
//        void replace_operand(std::string old_operand_name, std::shared_ptr<Op> new_operand) override;
        ...
        void append_sub_cluster_tags(const std::vector<std::string> &sub_cluster_tags);
        void append_sub_cluster_type(const std::string &sub_cluster_type);
        void append_sub_cluster_types(const std::vector<std::string> &sub_cluster_types);
        void set_sub_cluster_tag_order(const std::vector<std::string> &_sub_cluster_tag_order);
        void set_sub_cluster_type_order(const std::vector<std::string> &_sub_cluster_type_order);
    ...
    protected:
        ...
        const std::string async_pipeline_stage_count_codegen_var_name = "total_stage_count";
