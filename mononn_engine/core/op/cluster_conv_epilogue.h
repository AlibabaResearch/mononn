...
namespace core {
namespace op {
    class ClusterConvEpilogue : public ClusterOp {
    public:
        ClusterConvEpilogue(std::string _name, std::vector<std::shared_ptr<Op>> _operands, std::vector<TensorSpec> _output_specs)
