...
namespace gpu {
    class SmemManager {
    public:
        SmemManager(size_t _total_size_in_bytes) : SmemManager(_total_size_in_bytes, "__cache", 4) {}
        SmemManager(size_t _total_size_in_bytes, std::string _root_buffer_ptr, int _alignment_in_byte) 
        ...
        void claim_smem_buffer(std::string node_name, std::string buffer_name, size_t size_in_bytes);
        std::string get_buffer_pointer(std::string buffer_name, std::string as_type = "void *") const;
        ...
        void record_base_buffer_size(const std::string &buffer_name, size_t size_in_bytes);
