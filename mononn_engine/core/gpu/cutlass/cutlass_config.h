...
namespace gpu {
namespace cutlass {
    struct CutlassConfig : public mononn_engine::core::common::ProtoConverter<tensorflow::mononn_extra::proto::CutlassConfig> {
        ...
        std::unique_ptr<tensorflow::mononn_extra::proto::CutlassConfig> ConvertToProto() const override;
        void ParseFromProto(tensorflow::mononn_extra::proto::CutlassConfig const *cutlass_config) override;
    };
}
}
}
