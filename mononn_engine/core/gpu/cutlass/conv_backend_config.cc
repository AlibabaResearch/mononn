...
namespace gpu {
namespace cutlass {
    std::unique_ptr<tensorflow::mononn_extra::proto::ConvBackendConfig> ConvBackendConfig::ConvertToProto() const {
        std::unique_ptr<tensorflow::mononn_extra::proto::ConvBackendConfig> conv_backend_config = std::make_unique<tensorflow::mononn_extra::proto::ConvBackendConfig>();
    ...
    void ConvBackendConfig::ParseFromProto(const tensorflow::mononn_extra::proto::ConvBackendConfig *conv_backend_config) {
