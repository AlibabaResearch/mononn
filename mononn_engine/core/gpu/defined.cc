...
namespace gpu {
    ...
    const std::string CUDADefined::threadIdx_x_global =
            mononn_engine::helpers::string_format("(%s + %s * %s)", CUDADefined::threadIdx_x.c_str(), CUDADefined::blockIdx_x.c_str(), CUDADefined::blockDim_x.c_str());
    const std::string CUDADefined::threadCnt_x_global = 
            mononn_engine::helpers::string_format("(%s * %s)", CUDADefined::blockDim_x.c_str(), CUDADefined::gridDim_x.c_str());    
...
const int %s = %s %% %s;
        ...
        CUDADefined::warp_block_id.c_str(), CUDADefined::threadIdx_x.c_str(), CUDADefined::warpSize.c_str(),
        CUDADefined::warp_block_count.c_str(), CUDADefined::blockDim_x.c_str(), CUDADefined::warpSize.c_str(),
        CUDADefined::warp_global_id.c_str(), CUDADefined::warp_block_id.c_str(), CUDADefined::blockIdx_x.c_str(), CUDADefined::warp_block_count.c_str(),
        CUDADefined::warp_global_count.c_str(), CUDADefined::gridDim_x.c_str(), CUDADefined::warp_block_count.c_str(),
        CUDADefined::lane_id.c_str(), CUDADefined::threadIdx_x.c_str(), CUDADefined::warpSize.c_str());
    }
