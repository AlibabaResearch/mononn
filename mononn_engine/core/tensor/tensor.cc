...
namespace tensor {
    ...
    bool Tensor::valid() const {
        return this->tensor_spec.valid();
    }

    Dtype Tensor::get_dtype() const {
        return this->tensor_spec.get_dtype();
    }

    TensorShape Tensor::get_shape() const {
        return this->tensor_spec.get_shape();
    }
    ...
    int Tensor::element_count() const {
        return this->tensor_spec.element_count();
    }

    int Tensor::rank() const {
        return this->tensor_spec.rank();
    }
    ...
    std::string Tensor::to_string() const {
        return this->get_name() + " " + this->get_dtype().to_string() + this->tensor_spec.to_string();
    }
    ...
    TensorSpec Tensor::get_tensor_spec() const {
