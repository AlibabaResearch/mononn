...
namespace context {
    ...
    struct CUDADeviceContext : public mononn_engine::core::common::ProtoConverter<tensorflow::mononn_extra::proto::CUDADeviceContext> {
    public:
        CUDADeviceContext() {}
        CUDADeviceContext(
            int _device_count,
        ...
        std::unique_ptr<tensorflow::mononn_extra::proto::CUDADeviceContext> ConvertToProto() const;
        void ParseFromProto(tensorflow::mononn_extra::proto::CUDADeviceContext const *cuda_device_context);
    private:
