...
namespace context {
    ...
    public:
        ...
        static std::vector<std::string> offset_to_multi_index(TensorShape tensor_shape, std::string offset);
        static std::string multi_index_to_offset(TensorShape tensor_shape, std::vector<std::string> multi_index);
