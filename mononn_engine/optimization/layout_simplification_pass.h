...
namespace optimization {
    ...
    public:
        ...
        public:
            ...
            LayoutTransformSpec(const char *_spec) : LayoutTransformSpec(std::string(_spec)) {}
    ...
    private:
        std::vector<int> get_sequence_perm(std::vector<int> seq1, std::vector<int> seq2) const;
    };
}
}
